...
public:
    ...
    void hal_name()
    {
        ...
        {
            case 1:
            hall_name="CARNIVAL ARTI CINEMAHALL, BENACHITY";
            break;
             case 2:
            hall_name="SVF CINEMAS, BENACHITY";
            break;
             case 3:
            hall_name="CITYCENTRE MOVIEHALL";
            break;
             case 4:
            hall_name="CHITRALAYA MOVIE HALL, B-ZONE";
            break;
        }
...
fin.open("movie_test2.csv");
   ...
   getline(fin,name[i],',');
    fin.close();
            ...
            (*this).seatdisp(arg,sti);
            system("cls");
//calling ticket_print() function and printing the ticket
            (*this).ticket_print();
...
void movie_booking::show()//this function is for entering the number of movie running in hall
{
    ...
    cout<<"\n\n\t\t\t\t\t\t\tENTER THE NUMBER MOVIES YOU WANT TO ADD IN THE HALL\n";
    cout<<"\t\t\t\t\t\t\t";
    cin>>m;
    (*p)=m;
     ofstream fout;
...
//2nd arg is for the particular movie time
{
    ...
    //different pricing according to the seat preference

    cout<<"\n\nCOST OF RECLINEAR:Rs 500/-\n";
...
int main()
{
    ...
    while(1)
    {
        cout<<"\n\n\t\t\t\t\t\t\t PRESS 1 TO BOOK TICKET IN CARNIVAL ARTI CINEMAHALL, BENACHITY";
    cout<<"\n\n\t\t\t\t\t\t\t PRESS 2 TO BOOK TICKET IN SVF CINEMAS, BENACHITY";
    cout<<"\n\n\t\t\t\t\t\t\t PRESS 3 TO BOOK TICKET IN CITYCENTRE MOVIEHALL";
    cout<<"\n\n\t\t\t\t\t\t\t PRESS 4 TO BOOK TICKET IN CHITRALAYA MOVIE HALL, B-ZONE";
    ...
    switch(obn)
    {
        case 1:
            cout<<"\t\t\t\t\t\t\t";
            cout<<"CARNIVAL ARTI CINEMAHALL, BENACHITY IS SELECTED\n";
        obj[0].first();
        break;
        case 2:
        cout<<"\t\t\t\t\t\t\t";
            cout<<"SVF CINEMAS, BENACHITY IS SELECTED\n";
        obj[1].first();
        break;
        case 3:
        cout<<"\t\t\t\t\t\t\t";
             cout<<"CITYCENTRE MOVIEHALL  IS SELECTED\n";
        obj[2].first();
        break;
        case 4:
        cout<<"\t\t\t\t\t\t\t";
            cout<<"CHITRALAYA MOVIE HALL, B-ZONE  IS SELECTED\n";
        obj[3].first();
        break;
        case 9:
                goto bye;
